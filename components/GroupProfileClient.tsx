    ...
    <>
      ...
      <div className="fade-up profile-hero pt-[72px] grid grid-cols-1 md:grid-cols-2 min-h-[70vh]">
        ...
        <div className="relative overflow-hidden min-h-[350px]">
          ...
          {/* Badge overlay */}
          <span className="font-sans absolute top-4 left-4 bg-rose py-1 px-3.5 text-[14px] font-extrabold tracking-[0.12em] text-card-bg uppercase">
            {badgeLabel}
          </span>
        </div>
        ...
        <div className="profile-info-pad flex flex-col justify-center relative">
          {/* Badge label */}
          <div className="font-sans text-[14px] font-bold tracking-[0.2em] text-rose uppercase mb-3">
            {badgeLabel} Profile
          </div>
          ...
          {/* Bio */}
          {group.bio && (
            <p className="font-sans text-[22px] leading-[1.85] text-muted max-w-[440px] mb-6">
              {group.bio}
            </p>
          )}
      ...
      {members.length > 0 && (
        <div className="grid-pad max-w-[1200px] mx-auto">
          <div className="font-serif text-[17px] font-semibold tracking-[0.18em] text-rose uppercase mb-7">
            Member Details
          </div>
          <div
            style={{
              ...
              <div key={m.id}>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="font-sans text-[14px] text-muted tracking-wide uppercase">
                ...
                {categories.map((cat) => (
                  <div key={cat.id} className="mb-4">
                    <div className="font-serif text-[15px] font-semibold tracking-[0.14em] text-rose uppercase mb-2 pb-1.5 border-b border-sand">
                      {cat.title}
                    </div>
                    {cat.fields.map((f) => {
                      ...
                      return (
                        ...
                        >
                          <span className="font-sans text-[15px] font-medium text-muted tracking-[0.03em]">
                            {f.label}
                          </span>
