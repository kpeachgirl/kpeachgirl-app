    ...
    <div className="content-pad max-w-[1200px] mx-auto">
      <div className="font-sans flex justify-between items-center flex-wrap gap-3">
        ...
        <div className="filter-scroll flex gap-2 items-center">
          <span className="text-[12px] font-bold tracking-[0.14em] text-muted uppercase mr-2 whitespace-nowrap">
            Area
          </span>
          {allAreas.map((a) => (
            <button
        ...
        <div className="flex gap-4 items-center">
          <label className="font-sans flex items-center gap-1.5 text-[13px] font-semibold text-muted cursor-pointer">
            <input
              type="checkbox"
      ...
      {/* Model count */}
      <div className="font-sans text-[13px] text-charcoal mt-3 font-semibold tracking-[0.06em]">
