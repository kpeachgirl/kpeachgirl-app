    ...
    <>
      ...
      >
        ...
        <h1
          ...
          style={{ fontSize: 'clamp(35px, 6.6vw, 57px)', color: 'var(--charcoal)', lineHeight: 1 }}
        >
          K<span style={{ color: 'var(--rose)' }}>PEACH</span>GIRL
        </h1>
        <div className="w-12 h-0.5 bg-rose mx-auto" style={{ margin: '20px 0' }} />
        <p className="font-sans text-[11px] font-bold tracking-[0.25em] text-muted uppercase mb-5">
          {hero.subtitle}
        </p>
        {/* Phone */}
        <a
          ...
          style={{ fontSize: 'clamp(18px, 3.3vw, 24px)', fontWeight: 300, letterSpacing: '0.08em' }}
        >
          (213) 317-6530
        </a>
        {/* Search */}
        <input
          ...
          className="font-sans text-charcoal text-[14px] font-medium mt-8 w-full"
          style={{
            maxWidth: 400,
            padding: '13px 20px',
      ...
      <div className="grid-pad max-w-[1200px] mx-auto">
        ...
        {filtered.length === 0 && (
          <div className="text-center" style={{ padding: '80px 0' }}>
            <div className="font-serif text-[31px] font-light text-charcoal">
