...
export default function AgeGate({ children, config }: AgeGateProps) {
  ...
  return (
    <div className="font-sans fixed inset-0 z-[9999] bg-cream flex items-center justify-center">
      ...
      >
        {/* Logo */}
        <div className="font-serif text-[59px] font-light tracking-[-0.02em] text-charcoal leading-none">
        ...
        {/* Heading */}
        <div className="font-sans text-[15px] font-bold tracking-[0.2em] text-rose mb-2 uppercase">
          {c.heading}
        </div>

        {/* Description */}
        <p className="font-sans text-[17px] text-muted leading-[1.7] mb-8">
          {c.body}
        </p>
        ...
        <button
          ...
          className="font-sans w-full py-3.5 bg-charcoal text-cream border-none text-sm font-bold tracking-[0.15em] uppercase cursor-pointer transition-colors duration-300 hover:bg-rose"
        >
          {c.enterButton}
        </button>
        ...
        <button
          ...
          className="font-sans w-full py-3 mt-2 bg-card-bg text-charcoal border border-sand text-[15px] font-semibold tracking-[0.12em] uppercase cursor-pointer"
        >
          {c.leaveButton}
        </button>

        {/* Footer */}
        <p className="font-sans text-[14px] text-charcoal mt-6 leading-[1.5]">
          {c.disclaimer}
        </p>
      </div>
    </div>
