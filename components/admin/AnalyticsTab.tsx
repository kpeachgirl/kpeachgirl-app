...
export default function AnalyticsTab({ lang }: AnalyticsTabProps) {
  ...
  if (loading) {
    return (
      <div style={{ textAlign: 'center', padding: 60, color: 'var(--muted)', fontFamily: 'var(--font-sans)', fontSize: 17 }}>
        {t.loading}
      </div>
    );
  }
    ...
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        <div>
          ...
          <p style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--muted)', margin: '4px 0 0' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16, marginBottom: 24 }}>
        ...
        <div style={cardStyle}>
          ...
          <div style={{ ...bigNumberStyle, fontSize: 51, color: '#4ade80' }}>
            {data.liveVisitors}
          </div>
        </div>
        ...
        <div style={cardStyle}>
          ...
          <div style={{ ...bigNumberStyle, fontSize: 51 }}>{data.todayViews}</div>
        ...
        <div style={cardStyle}>
          ...
          <div style={{ ...bigNumberStyle, fontSize: 51 }}>{data.weekViews}</div>
        </div>

        {/* 30-Day Views */}
        <div style={cardStyle}>
          <div style={labelStyle}>{lang === 'ko' ? '30일 조회수' : '30-Day Views'}</div>
          <div style={{ ...bigNumberStyle, fontSize: 51 }}>{data.monthViews}</div>
        </div>
      </div>
          ...
          {data.liveVisitorDetails.map((v, i) => (
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--charcoal)', fontWeight: 600 }}>
                  {formatLocation(v.city, v.region, v.country)}
                </div>
                <div style={{ fontFamily: 'var(--font-sans)', fontSize: 13, color: 'var(--muted)', marginTop: 2 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', gap: 8, height: 140 }}>
          {data.dailyViews.map((day, i) => (
            <div key={i} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
              ...
              />
              <span style={{ fontFamily: 'var(--font-sans)', fontSize: 11, color: 'var(--muted)', textAlign: 'center' }}>
                {day.date.split(',')[0]}
              </span>
            </div>
          ))}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 16, marginBottom: 24 }}>
        ...
        <div style={cardStyle}>
          ...
          {data.topLocations.length === 0 ? (
            <div style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--muted)' }}>
            ...
            data.topLocations.map((loc, i) => (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
                  <span style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--charcoal)' }}>
          ...
          {data.topCountries.length === 0 ? (
            ...
            data.topCountries.map((c, i) => {
              ...
              return (
                ...
                >
                  <span style={{ fontSize: 24, width: 28, textAlign: 'center' }}>{flag}</span>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 4 }}>
                      <span style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--charcoal)', fontWeight: 500 }}>
                        {c.country}
                      </span>
                      <span style={{ fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 600, color: 'var(--peach)' }}>
      ...
      {gaData && (
        <div style={{ marginBottom: 24 }}>
          <div style={{ ...labelStyle, marginBottom: 16, fontSize: 15, letterSpacing: '0.05em' }}>
                  ...
                  {gaData.genderData.map(g => {
                    ...
                    return (
                      <div key={g.gender} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '6px 0' }}>
                        <span style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--charcoal)', display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        <span style={{ fontFamily: 'var(--font-sans)', fontSize: 15, fontWeight: 600, color: GENDER_COLORS[g.gender] || 'var(--charcoal)' }}>
                          {pct}% <span style={{ fontWeight: 400, color: 'var(--muted)', fontSize: 13 }}>({g.users})</span>
                        </span>
                      </div>
                    );
                  })}
                  ...
                  {gaData.ageBrackets.sort((a, b) => a.age.localeCompare(b.age)).map((bracket, i) => {
                    ...
                    return (
                      <div key={bracket.age} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
                        <span style={{ fontFamily: 'var(--font-sans)', fontSize: 12, color: 'var(--muted)' }}>{bracket.users}</span>
                        <div style={{
                          width: '100%',
                        ...
                        <span style={{ fontFamily: 'var(--font-sans)', fontSize: 11, color: 'var(--muted)', textAlign: 'center' }}>{bracket.age}</span>
                      </div>
                    );
                  })}
                </div>
                  ...
                  return (
                    <div key={interest.interest} style={{
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                        <span style={{ fontFamily: 'var(--font-sans)', fontSize: 14, color: 'var(--charcoal)', maxWidth: '70%', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                          {interest.interest}
                        </span>
                        <span style={{ fontFamily: 'var(--font-sans)', fontSize: 13, fontWeight: 600, color: 'var(--peach)' }}>{interest.users}</span>
                      </div>
          ...
          {gaData.error && (
            <div style={{ fontFamily: 'var(--font-sans)', fontSize: 13, color: 'var(--muted)', marginTop: 8, opacity: 0.6 }}>
            ...
            data.devices.map((d, i) => {
              ...
              return (
                <div key={d.name} style={{ padding: '8px 0', borderBottom: i < data.devices.length - 1 ? '1px solid rgba(255,255,255,0.04)' : 'none' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
                    <span style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--charcoal)' }}>{icon} {d.name}</span>
                    <span style={{ fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 600, color: 'var(--peach)' }}>{pct}%</span>
                  </div>
                  <div style={{ height: 4, borderRadius: 2, background: 'var(--sand)', overflow: 'hidden' }}>
            ...
            data.browsers.slice(0, 6).map((b, i) => {
              ...
              return (
                <div key={b.name} style={{ padding: '8px 0', borderBottom: i < Math.min(data.browsers.length, 6) - 1 ? '1px solid rgba(255,255,255,0.04)' : 'none' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
                    <span style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--charcoal)' }}>{b.name}</span>
                    <span style={{ fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 600, color: 'var(--rose)' }}>{pct}%</span>
                  </div>
                  <div style={{ height: 4, borderRadius: 2, background: 'var(--sand)', overflow: 'hidden' }}>
            ...
            data.operatingSystems.slice(0, 6).map((o, i) => {
              ...
              return (
                <div key={o.name} style={{ padding: '8px 0', borderBottom: i < Math.min(data.operatingSystems.length, 6) - 1 ? '1px solid rgba(255,255,255,0.04)' : 'none' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
                    <span style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--charcoal)' }}>{o.name}</span>
                    <span style={{ fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 600, color: 'var(--sage)' }}>{pct}%</span>
                  </div>
                  <div style={{ height: 4, borderRadius: 2, background: 'var(--sand)', overflow: 'hidden' }}>
            ...
            data.languages.slice(0, 6).map((l, i) => {
              ...
              return (
                <div key={l.name} style={{ padding: '8px 0', borderBottom: i < Math.min(data.languages.length, 6) - 1 ? '1px solid rgba(255,255,255,0.04)' : 'none' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
                    <span style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--charcoal)' }}>{l.name}</span>
                    <span style={{ fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 600, color: 'var(--charcoal)' }}>{pct}%</span>
                  </div>
                  <div style={{ height: 4, borderRadius: 2, background: 'var(--sand)', overflow: 'hidden' }}>
        ...
        <div style={cardStyle}>
          ...
          {data.topPages.length === 0 ? (
            ...
            data.topPages.map((page, i) => (
              ...
              >
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--charcoal)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '70%' }}>
                  {page.path}
                </span>
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 600, color: 'var(--rose)' }}>
                  {page.views}
                </span>
              </div>
            ))
          ...
          {data.topReferrers.length === 0 ? (
            ...
            data.topReferrers.map((ref, i) => (
              ...
              >
                ...
                <span style={{ fontFamily: 'var(--font-sans)', fontSize: 14, fontWeight: 600, color: 'var(--sage)' }}>
                  {ref.views}
                </span>
              </div>
            ))
            ...
            {data.recentActivity.map((entry, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontFamily: 'var(--font-sans)', fontSize: 15, color: 'var(--charcoal)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
