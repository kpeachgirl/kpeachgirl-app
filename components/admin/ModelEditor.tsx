      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            />
            <div>
              <div style={{ fontWeight: 700, fontSize: 17, color: 'var(--charcoal)' }}>
        ...
        <div style={{ padding: '20px 24px 100px' }}>
          ...
          <div style={{ marginBottom: 28 }}>
              ...
              <div>
                ...
                >
                  {form.profile_image ? (
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', fontSize: 13, color: 'var(--charcoal)', fontFamily: 'var(--font-sans)' }}>
            ...
            <div style={{ marginTop: 16 }}>
              ...
              {!model?.id ? (
                <div style={{ fontSize: 13, color: 'var(--muted)', padding: '12px 0', fontFamily: 'var(--font-sans)' }}>
                  {t.saveGalleryFirst}
                </div>
              ) : (
                <>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 6 }}>
                    {galleryImages.map((img, idx) => (
                      ...
                      >
                        ...
                        />
                        {/* Index number */}
                        <span style={{ position: 'absolute', top: 4, left: 6, fontSize: 11, color: '#ffffff', fontWeight: 700 }}>{idx + 1}</span>
                        {/* Delete */}
                        <button
                          type="button"
