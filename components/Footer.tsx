  ...
  return (
    <footer className="footer-pad border-t border-sand flex flex-col sm:flex-row justify-between items-center gap-3">
      ...
      <a
        ...
        className="font-sans text-[15px] font-medium tracking-[0.06em] text-muted no-underline hover:text-rose transition-colors"
      >
        kpeachgirl@hotmail.com
      </a>
      <span className="font-sans text-[14px] font-semibold tracking-[0.12em] text-charcoal uppercase">
