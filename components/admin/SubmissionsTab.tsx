    ...
    <div style={{ fontFamily: 'var(--font-sans)', color: 'var(--charcoal)' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          <h2 style={{ fontSize: 26, fontWeight: 600, margin: 0, fontFamily: 'var(--font-serif)' }}>
            {t.subTitle}
          </h2>
          <p style={{ color: 'var(--muted)', fontSize: 17, margin: '4px 0 0' }}>{t.subDesc}</p>
        </div>
        {newCount > 0 && (
          <span
            style={{
      ...
      >
        <div>
          <div style={{ fontWeight: 600, fontSize: 17, marginBottom: 2 }}>{t.subShareTitle}</div>
          <div style={{ color: 'var(--muted)', fontSize: 15 }}>{t.subShareDesc}</div>
        </div>
      ...
      {submissions.length === 0 && (
        ...
        >
          ...
          <p style={{ fontSize: 15 }}>{t.subShareDesc}</p>
        </div>
      )}
          ...
          return (
            ...
            >
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontWeight: 600, fontSize: 19 }}>{fd.name || 'Unknown'}</div>
                  <div style={{ color: 'var(--muted)', fontSize: 14, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              ...
              <div style={{ padding: '0 18px 14px' }}>
                ...
                >
                  {[
                    ...
                    item =>
                      item.value && (
                        <div key={item.label}>
                          <div style={{ color: 'var(--muted)', fontSize: 13, marginBottom: 2 }}>{item.label}</div>
                ...
                {/* Bio */}
                {fd.bio && (
                  <p style={{ color: 'var(--ink)', fontSize: 15, margin: '6px 0', lineHeight: 1.5 }}>
                    {fd.bio}
                  </p>
                )}
                ...
                {fd.social && (
                  <a
                    ...
                    style={{ color: 'var(--rose)', fontSize: 15, textDecoration: 'none' }}
                  >
                    {fd.social}
                  </a>
                )}
                ...
                {fd.id_verification && (
                  ...
                  >
                    ...
                    {fd.id_verification.issues?.length > 0 && (
                      <div style={{ fontSize: 13, color: 'var(--peach)', marginTop: 4 }}>
              ...
              {sub.status !== 'converted' && (
                ...
                >
                  ...
                  {sub.status === 'dismissed' && (
                    <span style={{ color: 'var(--muted)', fontSize: 14, padding: '5px 0' }}>
                      {t.subDismissed}
                    </span>
                  )}
                </div>
